...
---------- [ Window ] ----------
local Window = Library:CreateWindow('BorutoDEV - Fisch')
...
Changelog:addChangelog("[July, 14 2026]")
...
Settings:addToggle('Toggle Water Walking', function()
    ...
    -- Mengaktifkan atau menonaktifkan Water WaWalkinayer game.Players.LocalPlayer
