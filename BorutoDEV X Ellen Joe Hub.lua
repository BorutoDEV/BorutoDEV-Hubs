...
if game.PlaceId == 6403373529 or game.PlaceId == 9015014224 or game.PlaceId == 11520107397 or game.PlaceId == 124596094333302 then
    local Window = Library:CreateWindow({
        ...
        AutoShow = true,
        Resizable = true,
        Footer = "BorutoDEV | Ellen Joe <3 Hub Version: 2.0.5",
        Icon = 72462144048455,
...
elseif game.PlaceId == 11828384869 then
    local Window = Library:CreateWindow({
        Title = "BorutoDEV | Ellen Joe <3 Hub - Maze 👁️",
        Center = true,
        AutoShow = true,
        Resizable = true,
        AutoLock = true,
...
elseif game.PlaceId == 16034567693 then
    local Window = Library:CreateWindow({
        Title = "BorutoDEV | Ellen Joe <3 Hub - ADMIN ROOM",
        Center = true,
        AutoShow = true,
        Resizable = true,
        AutoLock = true,
...
elseif game.PlaceId == 17290438723 then
    local Window = Library:CreateWindow({
        Title = "BorutoDEV | Ellen Joe <3 Hub - Frostbite Map Obby",
        Center = true,
        AutoShow = true,
        Resizable = true,
        AutoLock = true,
