...
Tabs = {
    Tab = Window:Tab({Title = "Main"}),
    Tab1 = Window:Tab({Title = "Misc"}),
    Tab2 = Window:Tab({Title = "Esp"}),
    ["Info"] = Window:Tab({Title = "Information"}),
}
    ...
    Callback = function(Value)
        ...
        if Value then
            task.spawn(function()
                ...
                -- Disable Visual Effects (Lighting)
                ...
                -- Optimization for Particles and Materials (Keeps textures for puzzles)
                ...
                -- Optimize Lighting Properties
                Lighting.FogEnd = math.huge
                Lighting.FogStart = math.huge
                Lighting.Brightness = 3
                Lighting.GlobalShadows = false
                
                print("Anti-Lag: Enabled " .. count .. " optimizations.")
            end)
        else
...
local CoOwner = Info:Paragraph({
    Title = "Hub Icons",
    Desc = "Ellen Joe <3 (From Zenless Zone Zero) ",
    Image = "rbxassetid://72462144048455",
    ImageSize = 30,
    Thumbnail = "",
    ThumbnailSize = 0,
