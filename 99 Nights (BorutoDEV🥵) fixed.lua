...
WindUI:Popup({
    Title = "Savannah <3 Loaded | 99 Nights in the Forest",
    Icon = "rbxassetid://72462144048455",
    IconThemed = true,
    Content = "BorutoDEV Hub is SUPER op",
    Buttons = {
...
local Window = WindUI:CreateWindow({
    ...
    Title = "Savannah <3 | V1 | 99 Nights In The Forest | Beta",
    IconThemed = true,
    Icon = "rbxassetid://72462144048455",
    Author = "",
...
local espTypes = {
    ["Fuel All"] = {
        ...
        items = { "Log", "Fuel Canister", "Coal", "Oil Barrel", " Biofuel"}
    },
    ["Scraps All"] = {
    ...
    ["body All"] = {
        ...
        items = { "Leather Body", "Iron Body", " Alien Body", "Thorn Body" }
    },
    ["Bandage"] = {
...
Tabs.Bring:Button({ Title = "Bring All Scrap", Callback = function()
    local root = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
    if not root then return end
    local scrapNames = {
...
Tabs.Bring:Button({Title="Bring Raw + Cooked Meat", Callback=function()
    local root = LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("HumanoidRootPart")
    for _, item in pairs(workspace.Items:GetChildren()) do
        local name = item.Name:lower()
...
Tabs.Hitbox:Slider({Title="Hitbox Size", Min=2, Max=250, Default=10, Step=1, Callback=function(val) hitboxSettings.Size=val end})
...
Tabs.Player:Toggle({
    ...
    Callback = function(state)
        ...
        if state then
            ...
            local connection = humanoid:GetAttribute("GodModeConnection")
            if connection then
