...
local Window = WindUI:CreateWindow({
    Title = "99 Nights in forest | Savannah <3",
    Icon = "rbxassetid://72462144048455", 
    Author = "BorutoDEV",
    Folder = "RobloxExploots",
...
local Owner = Info:Paragraph({
    Title = "Main Founder",
    Desc = "Developed & Scripted by: BorutoDEV",
...
local CoOwner = Info:Paragraph({
    Title = "Ellen Joe <3",
    Desc = "Hub Icons from Ellen Joe (Zenless Zone Zero)",
    ...
    Buttons = {
        {
            ...
            Title = "Copy Link",
            Callback = function()
                setclipboard("https://discord.gg/CraqPh932n")
