...
local BorutoDEVAndroidUI = Instance.new("ScreenGui")
...
local BorutoDEVLogo = Instance.new("ImageLabel")
...
local BorutoDEVLogo_2 = Instance.new("ImageLabel")
...
local BorutoDEVMenuToggleFrame = Instance.new("Frame")
local UICorner_35 = Instance.new("UICorner")
local BorutoDEVMenuToggle = Instance.new("TextButton")
...
local BorutoDEVLogo_3 = Instance.new("ImageLabel")
...
local BorutoDEVKSToggle = Instance.new("TextButton")
...
local BorutoDEVLogo_4 = Instance.new("ImageLabel")
...
BorutoDEVAndroidUI.Name = "BorutoDEVAndroidUI"
BorutoDEVAndroidUI.Parent = gethui()

SettingsWindow.Name = "SettingsWindow"
SettingsWindow.Parent = BorutoDEVAndroidUI
...
SubTitle.Text = "Developed by BorutoDEV"
...
BorutoDEVLogo.Name = "BorutoDEVLogo"
BorutoDEVLogo.Parent = S0
BorutoDEVLogo.AnchorPoint = Vector2.new(0, 0.5)
BorutoDEVLogo.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
BorutoDEVLogo.BackgroundTransparency = 1.000
BorutoDEVLogo.BorderSizePixel = 0
BorutoDEVLogo.Position = UDim2.new(0, 25, 0.5, 0)
BorutoDEVLogo.Size = UDim2.new(0, 52, 0, 52)
BorutoDEVLogo.ZIndex = 21
BorutoDEVLogo.Image = "http://www.roblox.com/asset/?id=72462144048455"
...
SubTitle_3.Text = "Allow BorutoDEV Cross Platform Connection with the Windows UI."
...
SubTitle_4.Text = "Change BorutoDEV  Button Colors."
...
SubTitle_5.Text = "立即跳转到 BorutoDEV"
...
ScriptHubWindow.Parent = BorutoDEVAndroidUI
...
ExecutorWindow.Parent = BorutoDEVAndroidUI
...
SidebarFrame.Parent = BorutoDEVAndroidUI
...
BorutoDEVLogo_2.Name = "BorutoDEVLogo"
BorutoDEVLogo_2.Parent = Banner
BorutoDEVLogo_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
BorutoDEVLogo_2.BackgroundTransparency = 1.000
BorutoDEVLogo_2.BorderSizePixel = 0
BorutoDEVLogo_2.Position = UDim2.new(0, 10, 0, 50)
BorutoDEVLogo_2.Size = UDim2.new(0, 25, 0, 25)
BorutoDEVLogo_2.Image = "http://www.roblox.com/asset/?id=72462144048455"
...
ImageLabel_4.Image = "rbxassetid://72462144048455"
ImageLabel_4.ImageRectOffset = Vector2.new(324, 124)
ImageLabel_4.ImageRectSize = Vector2.new(36, 36)

BorutoDEVMenuToggleFrame.Name = "BorutoDEVMenuToggleFrame"
BorutoDEVMenuToggleFrame.Parent = BorutoDEVAndroidUI
BorutoDEVMenuToggleFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
BorutoDEVMenuToggleFrame.BackgroundTransparency = 0.500
BorutoDEVMenuToggleFrame.BorderSizePixel = 0
BorutoDEVMenuToggleFrame.ClipsDescendants = true
BorutoDEVMenuToggleFrame.Position = UDim2.new(0, 104, 0, -32)
BorutoDEVMenuToggleFrame.Size = UDim2.new(0, 64, 0, 32)
BorutoDEVMenuToggleFrame.Visible = true
BorutoDEVMenuToggleFrame.ZIndex = 10

UICorner_35.CornerRadius = UDim.new(0, 10)
UICorner_35.Parent = BorutoDEVMenuToggleFrame

BorutoDEVMenuToggle.Name = "BorutoDEVMenuToggle"
BorutoDEVMenuToggle.Parent = BorutoDEVMenuToggleFrame
BorutoDEVMenuToggle.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
BorutoDEVMenuToggle.BackgroundTransparency = 1.000
BorutoDEVMenuToggle.BorderSizePixel = 0
BorutoDEVMenuToggle.Size = UDim2.new(0, 32, 0, 32)
BorutoDEVMenuToggle.ZIndex = 11
BorutoDEVMenuToggle.Font = Enum.Font.SourceSans
BorutoDEVMenuToggle.Text = ""
BorutoDEVMenuToggle.TextColor3 = Color3.fromRGB(0, 0, 0)
BorutoDEVMenuToggle.TextSize = 14.000

UICorner_36.CornerRadius = UDim.new(0, 10)
UICorner_36.Parent = BorutoDEVMenuToggle

ImageLabel_5.Parent = BorutoDEVMenuToggle
...
ImageLabel_5.Image = "https://www.roblox.com/asset/?id=72462144048455"

DragTouch.Name = "DragTouch"
DragTouch.Parent = BorutoDEVMenuToggleFrame
...
KeySystem.Parent = BorutoDEVAndroidUI
...
MainTitle.Text = "[BorutoDEV] Key System"
...
BorutoDEVLogo_3.Name = "BorutoDEVLogo"
BorutoDEVLogo_3.Parent = Banner_2
BorutoDEVLogo_3.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
BorutoDEVLogo_3.BackgroundTransparency = 1.000
BorutoDEVLogo_3.BorderSizePixel = 0
BorutoDEVLogo_3.Position = UDim2.new(0, 10, 0, 10)
BorutoDEVLogo_3.Size = UDim2.new(0, 25, 0, 25)
BorutoDEVLogo_3.Image = "https://www.roblox.com/asset/?id=72462144048455"
...
KSMenuToggleFrame.Parent = BorutoDEVAndroidUI
...
BorutoDEVKSToggle.Name = "BorutoDEVKSToggle"
BorutoDEVKSToggle.Parent = KSMenuToggleFrame
BorutoDEVKSToggle.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
BorutoDEVKSToggle.BackgroundTransparency = 1.000
BorutoDEVKSToggle.BorderSizePixel = 0
BorutoDEVKSToggle.Size = UDim2.new(0, 32, 0, 32)
BorutoDEVKSToggle.ZIndex = 11
BorutoDEVKSToggle.Font = Enum.Font.SourceSans
BorutoDEVKSToggle.Text = ""
BorutoDEVKSToggle.TextColor3 = Color3.fromRGB(0, 0, 0)
BorutoDEVKSToggle.TextSize = 14.000

UICorner_44.CornerRadius = UDim.new(0, 10)
UICorner_44.Parent = BorutoDEVKSToggle

ImageLabel_6.Parent = BorutoDEVKSToggle
...
ImageLabel_6.Image = "https://www.roblox.com/asset/?id=72462144048455"

IntroFrame.Name = "IntroFrame"
IntroFrame.Parent = BorutoDEVAndroidUI
...
BorutoDEVLogo_4.Name = "BorutoDEVLogo"
BorutoDEVLogo_4.Parent = IntroFrame
BorutoDEVLogo_4.AnchorPoint = Vector2.new(0.5, 0.5)
BorutoDEVLogo_4.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
BorutoDEVLogo_4.BackgroundTransparency = 1.000
BorutoDEVLogo_4.BorderSizePixel = 0
BorutoDEVLogo_4.Position = UDim2.new(0.5, 0, 0.699999988, 0)
BorutoDEVLogo_4.Size = UDim2.new(0, 100, 0, 100)
BorutoDEVLogo_4.ZIndex = 21
BorutoDEVLogo_4.Image = "https://www.roblox.com/asset/?id=72462144048455"
BorutoDEVLogo_4.ImageTransparency = 1.000

ScriptListWindow.Name = "ScriptListWindow"
ScriptListWindow.Parent = BorutoDEVAndroidUI
...
WindowSubTitle_2.Text = "Love the Executor? - BorutoDEV"
...
local function UENDBFZ_fake_script() -- BorutoDEVAndroidUI.EverythingElse 
	local script = Instance.new('LocalScript', BorutoDEVAndroidUI)
	...
	getgenv().DevConnect = function(devcode)
		warn("(BD STUDIO! | HTTP Protocol [ Beta ])")
	...
	local gui = script.Parent.BorutoDEVMenuToggleFrame
	...
	script.Parent.BorutoDEVMenuToggleFrame.BorutoDEVMenuToggle.MouseButton1Click:connect(function()	
	...
	script.Parent.ExecutorWindow.DevModeB.MouseButton1Click:connect(function()
		if isfile("injectcode.txt") == false then
			script.Parent.ExecutorWindow.ScrollingBox.TextBox.Text = "The inject code for Dev Mode is not found, please open the BorutoDEV Windows Client, get your inject code, and paste it in settings."
		else
...
local function VJJF_fake_script() -- BorutoDEVAndroidUI.SettingsSystem 
	local script = Instance.new('LocalScript', BorutoDEVAndroidUI)
	...
	--if not isfile("theme_borutodev_color.txt") then
		--writefile("theme_borutodev_color.txt", "#C33939")
	--else
		--ChosenColor = readfile("theme_borutodev_color.txt")
	...
	script.Parent.SettingsWindow.ScrollingFrame.S1.SubmitAccent.MouseButton1Click:Connect(function()
		writefile("theme_borutodev_color.txt", script.Parent.SettingsWindow.ScrollingFrame.S1.AccentTextBox.Text)
...
local function KJDH_fake_script() -- BorutoDEVAndroidUI.Loading 
	local script = Instance.new('LocalScript', BorutoDEVAndroidUI)
	...
	function Generate_Key()
		return PandaAuth:GetKey("borutodev");
	end
	
	function ValidateKey(Key)
		return PandaAuth:ValidateKey("borutodev", tostring(Key))
	end
	...
	if not isfile("borutodev_key.txt") then
		writefile("borutodev_key.txt", "")
	end
	
	script.Parent.BorutoDEVMenuToggleFrame.Visible = true
	...
	game:GetService("TweenService"):Create(script.Parent.IntroFrame.BorutoDEVLogo, TweenInfo.new(1), {ImageTransparency = 0}):Play()
	script.Parent.IntroFrame.BorutoDEVLogo:TweenPosition(UDim2.new(0.5,0,0.5,0), "Out", "Quad", 1, true)
	
	wait(1.5)
	
	game:GetService("TweenService"):Create(script.Parent.IntroFrame.BorutoDEVLogo, TweenInfo.new(1), {ImageTransparency = 1}):Play()
	script.Parent.IntroFrame.BorutoDEVLogo:TweenPosition(UDim2.new(0.5,0,0.3,0), "Out", "Quad", 1, true)
	...
	local success, result = pcall(function()
		return ValidateKey(readfile("borutodev_key.txt"))
	end)
	...
	script.Parent.KSMenuToggleFrame.BorutoDEVKSToggle.MouseButton1Click:connect(function()
	...
	script.Parent.KeySystem.ApproveKeyB.MouseButton1Click:connect(function()
		...
		if ValidateKey(script.Parent.KeySystem.TextBox.Text) then
			writefile("borutodev_key.txt", script.Parent.KeySystem.TextBox.Text)
			-- LoadAutoexec()
