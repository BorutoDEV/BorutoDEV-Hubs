...
--     warn("❌ This script must only be executed from the offical BorutoDEV loader")
--         return
--     end
...
-- _G.__userKey = nil
print("✅ Security verification passed. Loading BorutoDEV...")
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("BorutoDEV") then
			makefolder("BorutoDEV");
		end;
		if not isfolder("BorutoDEV/Blox Fruits/") then
			makefolder("BorutoDEV/Blox Fruits/");
		end;
		if not isfile(("BorutoDEV/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("BorutoDEV/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("BorutoDEV/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("BorutoDEV/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("BorutoDEV/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
